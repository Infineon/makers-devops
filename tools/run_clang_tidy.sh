...
usage() {
  ...
  echo "          [--header-filter] <Header filter regex for headers to be processed.>  [-I] <Directory to search for incldue files.>  [-i] <Source files or directory not to be processed.>" 1>&2;
